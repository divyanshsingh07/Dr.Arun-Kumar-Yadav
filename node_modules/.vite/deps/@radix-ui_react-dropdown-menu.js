...
function useComposedRefs4(...refs) {
  return React15.useCallback(composeRefs4(...refs), refs);
}
...
function useComposedRefs5(...refs) {
  return React24.useCallback(composeRefs5(...refs), refs);
}
...
function createSlotClone4(ownerName) {
  const SlotClone = React25.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React25.isValidElement(children) ? getElementRef4(children) : void 0;
...
var FocusScope = React27.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = useComposedRefs5(forwardedRef, (node) => setContainer(node));
...
function useComposedRefs6(...refs) {
  return React30.useCallback(composeRefs6(...refs), refs);
}
...
function createSlotClone5(ownerName) {
  const SlotClone = React31.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React31.isValidElement(children) ? getElementRef5(children) : void 0;
...
function isSlottable5(child) {
  return React31.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
function useComposedRefs7(...refs) {
  return React34.useCallback(composeRefs7(...refs), refs);
}
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React36.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime20.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React36.isValidElement(newElement) ? React36.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone6(ownerName) {
  const SlotClone = React36.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React36.isValidElement(children) ? getElementRef6(children) : void 0;
    const ref = useComposedRefs7(childrenRef, forwardedRef);
...
function isSlottable6(child) {
  return React36.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var PopperContent = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs7(forwardedRef, (node) => setContent(node));
...
function useComposedRefs8(...refs) {
  return React40.useCallback(composeRefs8(...refs), refs);
}
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React41.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime23.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React41.isValidElement(newElement) ? React41.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone7(ownerName) {
  const SlotClone = React41.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React41.isValidElement(children) ? getElementRef7(children) : void 0;
...
function isSlottable7(child) {
  return React41.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
function useComposedRefs9(...refs) {
  return React44.useCallback(composeRefs9(...refs), refs);
}
...
var Presence = (props) => {
  ...
  const ref = useComposedRefs9(presence.ref, getElementRef8(child));
...
function createSlot8(ownerName) {
  ...
  const Slot22 = React46.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime26.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React46.isValidElement(newElement) ? React46.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone8(ownerName) {
  const SlotClone = React46.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React46.isValidElement(children) ? getElementRef9(children) : void 0;
...
function isSlottable8(child) {
  return React46.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER8;
}
...
function useComposedRefs10(...refs) {
  return React48.useCallback(composeRefs10(...refs), refs);
}
...
function createContextScope5(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function createContext32(rootComponentName, defaultContext) {
    const BaseContext = React49.createContext(defaultContext);
    const index2 = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    const Provider = (props) => {
      var _a;
      const { scope, children, ...context } = props;
      const Context = ((_a = scope == null ? void 0 : scope[scopeName]) == null ? void 0 : _a[index2]) || BaseContext;
      const value = React49.useMemo(() => context, Object.values(context));
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React49.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = (scope == null ? void 0 : scope[scopeName]) || scopeContexts;
...
function composeContextScopes5(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React49.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
  createScope.scopeName = baseScope.scopeName;
  return createScope;
...
function createSlot9(ownerName) {
  ...
  const Slot22 = React50.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime29.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React50.isValidElement(newElement) ? React50.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone9(ownerName) {
  const SlotClone = React50.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React50.isValidElement(children) ? getElementRef10(children) : void 0;
...
function isSlottable9(child) {
  return React50.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
var RovingFocusGroupImpl = React52.forwardRef((props, forwardedRef) => {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = React52.useState(false);
  const handleEntryFocus = useCallbackRef(onEntryFocus);
  const getItems = useCollection(__scopeRovingFocusGroup);
  const isClickFocusRef = React52.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = React52.useState(0);
  React52.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return (0, import_jsx_runtime31.jsx)(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: React52.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: React52.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: React52.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: React52.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
...
var RovingFocusGroupItem = React52.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var SideCar = function(_a) {
  ...
  return React56.createElement(Target, __assign({}, rest));
};
...
var RemoveScroll = React57.forwardRef(function(props, parentRef) {
  ...
  return React57.createElement(
    React57.Fragment,
    null,
    enabled && React57.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
    forwardProps ? React57.cloneElement(React57.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef })) : React57.createElement(Container, __assign({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
function RemoveScrollSideCar(props) {
  ...
  var id = React60.useState(idCounter++)[0];
  var Style2 = React60.useState(styleSingleton)[0];
  ...
  return React60.createElement(
    React60.Fragment,
    null,
    inert ? React60.createElement(Style2, { styles: generateStyle(id) }) : null,
    removeScrollBar ? React60.createElement(RemoveScrollBar, { gapMode: props.gapMode }) : null
  );
}
...
// node_modules/react-remove-scroll/dist/es2015/Combination.js
var ReactRemoveScroll = React61.forwardRef(function(props, ref) {
  return React61.createElement(RemoveScroll, __assign({}, props, { ref, sideCar: sidecar_default }));
});
